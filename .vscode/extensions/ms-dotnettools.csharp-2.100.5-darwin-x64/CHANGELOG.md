...
* Bump Razor to 10.0.0-preview.25252.1 (PR: [#8239](https://github.com/dotnet/vscode-csharp/pull/8239))
  * If SupportDiagnostics is false then dynamic files don't report diagnostics... (PR: [#11807](https://github.com/dotnet/vscode-csharp/issues/11807))
  * Client settings tweaks, and implement VS Code configuration monitoring (PR: [#11800](https://github.com/dotnet/vscode-csharp/issues/11800))
  * [main] [PRERELEASE] If SupportDiagnostics then dynamic files don't report diagnostics... (PR: [#11810](https://github.com/dotnet/vscode-csharp/issues/11810))
  * Update RazorSyntaxGenerator to reduce generated syntax code (PR: [#11806](https://github.com/dotnet/vscode-csharp/issues/11806))
  * Improve initialization, logging, and add more features to cohosting in VS Code (PR: [#11788](https://github.com/dotnet/vscode-csharp/issues/11788))
...
* Bump xamltools to 17.14.35807.11 (PR: [#7976](https://github.com/dotnet/vscode-csharp/ https:/github.com/dotnet/vscode-csharp/pull/7976))
