        ...
        <div className="grammar-modal" style={{position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
          <div style={{background: '#2e3440', color: '#eceff4', padding: '2rem', borderRadius: '1rem', maxWidth: '90vw', maxHeight: '80vh', overflowY: 'auto', boxShadow: '0 2px 16px #0008'}}>
            ...
            <div style={{marginBottom: '2rem'}}>
              ...
              <ul style={{columns:2, marginBottom:'1.5rem'}}>
                <li>durch</li><li>für</li><li>gegen</li><li>ohne</li><li>um</li><li>bis</li><li>entlang</li>
              </ul>
              <h3>Verben, die immer den Akkusativ verlangen</h3>
              <ul style={{columns:2, marginBottom:'1.5rem'}}>
                <li>sehen</li><li>finden</li><li>brauchen</li><li>kaufen</li><li>lieben</li><li>mögen</li><li>nehmen</li><li>lesen</li><li>trinken</li><li>essen</li><li>hören</li><li>vergessen</li><li>verstehen</li><li>lernen</li><li>öffnen</li><li>schließen</li><li>tragen</li><li>suchen</li><li>bekommen</li><li>warten (auf)</li><li>fragen</li><li>besuchen</li><li>spielen</li><li>machen</li><li>bauen</li><li>putzen</li><li>backen</li>
              </ul>
              <h3>Präpositionen, die immer den Dativ verlangen</h3>
              <ul style={{columns:2, marginBottom:'1.5rem'}}>
                <li>aus</li><li>bei</li><li>mit</li><li>nach</li><li>seit</li><li>von</li><li>zu</li><li>gegenüber</li>
              </ul>
              <h3>Häufige Verben, die immer den Dativ verlangen</h3>
              <ul style={{columns:2, marginBottom:'1.5rem'}}>
                <li>helfen</li><li>danken</li><li>gehören</li><li>glauben</li><li>folgen</li><li>gefallen</li><li>gratulieren</li><li>vertrauen</li><li>verzeihen</li><li>antworten</li><li>passen</li><li>schmecken</li><li>raten</li><li>zuhören</li><li>wehtun</li><li>fehlen</li>
              </ul>
            </div>
